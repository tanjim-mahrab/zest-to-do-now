        ...
        <div className="max-w-md w-full space-y-8 text-center">
          ...
          <div className="grid grid-cols-2 gap-4 my-8">
            {features.map((feature, index) => (
              <Card key={index} className="p-4 border border-black bg-white animate-slide-up" 
          ...
          <div className="space-y-4">
            <Button 
              ...
              className="w-full h-12 bg-black text-white font-semibold rounded-xl shadow-lg hover:bg-gray-800"
            >
              Get Started
            </Button>
            ...
            <Button 
              ...
              className="w-full h-12 border-2 border-black text-black font-semibold rounded-xl hover:bg-black hover:text-white"
            >
